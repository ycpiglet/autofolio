"""FastAPI application factory — Autofolio API (Phase 1).
...
SAFETY invariants enforced here:
  ...
  2. All state-changing paths (Phase 3) will require require_owner (403 for guest).
...
from app.api.routers import analysis, auth, engine, market, portfolio, trade
