...
| [TASK-045](TASK-045-ui-overhaul-phase1-api-foundation-login.md) | 대기 | Backend Engineer | UI 대개편 Phase 1 — FastAPI 기초 + 인증 + 읽기 API / Next.js 스캐폴드 + 로그인 → v1 |
| [TASK-046](TASK-046-ui-overhaul-phase2-home-portfolio.md) | 대기 | UI/UX Designer | UI 대개편 Phase 2 — 홈 + 포트폴리오 (읽기 화면) → v1 |
