...
> 작업 레지스트리. 열린 작업 보드는 `BACKLOG.md`(generate_views 자동 생성). 제품 백로그는 `docs/BACKLOG.md`.

| TASK | 상태 | Owner | 비고 |
|------|------|-------|------|
| [TASK-002](TASK-002-kis-reference-pack.md) | 완료 | Lead Engineer | - |
| [TASK-003](TASK-003-bilingual-readme.md) | 완료 | Lead Engineer | - |
| [TASK-004](TASK-004-runtime-update-gate.md) | 완료 | Lead Engineer | - |
| [TASK-005](TASK-005-doc-and-backlog-link-hygiene.md) | 완료 | Lead Engineer | - |
| [TASK-006](TASK-006-cycle-review-sequencing.md) | 완료 | Lead Engineer | - |
| [TASK-007](TASK-007-roles-due-alignment.md) | 완료 | Lead Engineer | - |
| [TASK-008](TASK-008-streamlit-legacy-wrapper.md) | 완료 | Lead Engineer | - |
| [TASK-009](TASK-009-orchestrator-import-check.md) | 완료 | Lead Engineer | - |
| [TASK-010](TASK-010-kis-websocket-realtime.md) | 완료 | KIS API Engineer | WebSocket 실시간 (체결통보·현재가·호가) |
| [TASK-011](TASK-011-kis-intraday-chart.md) | 완료 | KIS API Engineer | 분봉 데이터 조회 |
| [TASK-012](TASK-012-kis-long-term-order-history.md) | 완료 | KIS API Engineer | 장기 거래내역 조회 (3개월+) |
| [TASK-013](TASK-013-kis-batch-price.md) | 완료 | KIS API Engineer | 복수 종목 현재가 배치 조회 |
| [TASK-014](TASK-014-kis-after-hours-order.md) | 완료 | KIS API Engineer | 시간외 주문 (장전·장후 단일가) → v1 |
| [TASK-015](TASK-015-kis-index-price.md) | 완료 | KIS API Engineer | 지수 조회 (KOSPI·KOSDAQ·KOSPI200) |
| [TASK-016](TASK-016-kis-fundamental-data.md) | 완료 | KIS API Engineer | 기업 재무정보 (PER·PBR·EPS·시가총액) |
| [TASK-017](TASK-017-kis-dividend-info.md) | 완료 | KIS API Engineer | 배당 정보 조회 |
| [TASK-018](TASK-018-kis-order-book.md) | 완료 | KIS API Engineer | 호가창 10단계 조회 |
| [TASK-019](TASK-019-kis-sector-price.md) | 완료 | KIS API Engineer | 업종별 시세 조회 |
| [TASK-020](TASK-020-kis-disclosure.md) | 완료 | KIS API Engineer | 공시 정보 조회 |
| [TASK-021](TASK-021-kis-margin-short.md) | 완료 | KIS API Engineer | 신용·공매도 주문 (SLL_TYPE) → v1 |
| [TASK-022](TASK-022-kis-overseas-order.md) | 완료 | KIS API Engineer | 해외주식 주문 (미국·홍콩 등) → v1 |
| [TASK-023](TASK-023-kis-engine-e2e-validation.md) | 완료 | KIS API Engineer | UI 엔진 → KIS 실주문 E2E 검증 |
| [TASK-024](TASK-024-paper-scenario-matrix-validation.md) | 완료 | QA | Paper scenario matrix validation |
| [TASK-025](TASK-025-quant-trading-scenario-catalog.md) | 완료 | QA | Quant trading scenario catalog |
| [TASK-026](TASK-026-krx-alternative-products-test-support.md) | 완료 | KIS API Engineer | KRX alternative products test support → v1 |
| [TASK-027](TASK-027-krx-derivatives-test-support.md) | 완료 | KIS API Engineer | KRX derivatives test support → v1 |
| [TASK-028](TASK-028-advanced-order-types-test-support.md) | 완료 | Backend Engineer | Advanced order types test support → v1 |
| [TASK-029](TASK-029-fix-style-order-lifecycle-tests.md) | 완료 | Backend Engineer | FIX-style order lifecycle tests |
| [TASK-030](TASK-030-block-basket-execution-tests.md) | 완료 | Backend Engineer | Block/basket execution tests → v1 |
| [TASK-031](TASK-031-market-halt-vi-risk-gates.md) | 완료 | Compliance Officer | Market halt/VI risk gates → v1 |
| [TASK-032](TASK-032-data-quality-corporate-action-tests.md) | 완료 | Data Engineer | Data quality and corporate action tests → v1 |
...
| [TASK-038](TASK-038-watchlist-screener-alert-expansion.md) | 완료 | UI/UX Designer | Watchlist/screener/alert rule expansion → v1 |
| [TASK-039](TASK-039-backtest-research-report-hardening.md) | 완료 | Quant Researcher | Backtest research report hardening |
| [TASK-040](TASK-040-portfolio-performance-tax-lot-reporting.md) | 완료 | Performance Analyst | Portfolio performance and tax-lot style reporting → v1 |
...
| [TASK-048](TASK-048-ui-overhaul-phase4-agents-sse.md) | 완료 | Backend Engineer | UI 대개편 Phase 4 — 에이전트/IC + 알림 + SSE → v1 |
| [TASK-049](TASK-049-ui-overhaul-phase5-analysis-parity-retire.md) | 완료 | UI/UX Designer | UI 대개편 Phase 5 — 분석 화면 + 패리티 감사 + Streamlit 은퇴 → v1 |
...
| [TASK-061](TASK-061-feat-price-alert-engine-loop.md) | 완료 | Backend Engineer | feat: 가격 알림 엔진 평가 루프 구현 (dead feature 해소) → v1 |
...
| [TASK-066](TASK-066-test-coverage-60pct.md) | 완료 | QA | feat: 테스트 커버리지 60%+ — 안전-임계 실패모드 테스트 55개 추가 |
...
| [TASK-069](TASK-069-product-maturity-reassessment-2026-12.md) | 보류 | Lead Engineer | 제품 성숙도 반기 재평가 (2026-12-14) → v1 |
