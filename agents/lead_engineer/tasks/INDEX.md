...
| [TASK-014](TASK-014-kis-after-hours-order.md) | 보류 | KIS API Engineer | 시간외 주문 (장전·장후 단일가) → v1 |
...
| [TASK-021](TASK-021-kis-margin-short.md) | 보류 | KIS API Engineer | 신용·공매도 주문 (SLL_TYPE) → v1 |
| [TASK-022](TASK-022-kis-overseas-order.md) | 보류 | KIS API Engineer | 해외주식 주문 (미국·홍콩 등) → v1 |
...
| [TASK-026](TASK-026-krx-alternative-products-test-support.md) | 보류 | KIS API Engineer | KRX alternative products test support → v1 |
| [TASK-027](TASK-027-krx-derivatives-test-support.md) | 보류 | KIS API Engineer | KRX derivatives test support → v1 |
| [TASK-028](TASK-028-advanced-order-types-test-support.md) | 보류 | Backend Engineer | Advanced order types test support → v1 |
| [TASK-029](TASK-029-fix-style-order-lifecycle-tests.md) | 완료 | Backend Engineer | FIX-style order lifecycle tests |
| [TASK-030](TASK-030-block-basket-execution-tests.md) | 보류 | Backend Engineer | Block/basket execution tests → v1 |
| [TASK-031](TASK-031-market-halt-vi-risk-gates.md) | 보류 | Compliance Officer | Market halt/VI risk gates → v1 |
| [TASK-032](TASK-032-data-quality-corporate-action-tests.md) | 보류 | Data Engineer | Data quality and corporate action tests → v1 |
...
| [TASK-049](TASK-049-ui-overhaul-phase5-analysis-parity-retire.md) | 보류 | UI/UX Designer | UI 대개편 Phase 5 — 분석 화면 + 패리티 감사 + Streamlit 은퇴 → v1 |
