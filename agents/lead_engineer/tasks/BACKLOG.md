...
> 생성 시각: `2026-06-12T23:46:16+09:00` · 열린 작업 11건
...
| 지표 | 값 | 해석 |
|------|----|------|
| 열린 작업 | 11건 / 68 ph | frontmatter 기준 |
| 진행 중 WIP | 1건 | WIP 적정 |
| 대기 | 2건 | 최상위 자율 후보: 대기 중 ACT 후보 없음 |
| 보류 | 8건 | Owner/외부 조건 또는 의도적 defer |
| 실행성 | ACT 1 / REVIEW 2 / ASK 8 / DEFER 0 | ACT는 승인 없이 진행 가능, ASK/DEFER는 멈춤 |
