...
> 생성 시각: `2026-06-21T17:10:46+09:00` · 열린 작업 6건
...
| 지표 | 값 | 해석 |
|------|----|------|
| 열린 작업 | 6건 / 60 ph | frontmatter 기준 |
| 진행 중 WIP | 0건 | WIP 적정 |
| 대기 | 3건 | 최상위 자율 후보: TASK-173 (portfolio goal gap read model) |
| 보류 | 3건 | Owner/외부 조건 또는 의도적 defer |
| 실행성 | ACT 2 / REVIEW 1 / ASK 1 / DEFER 2 | ACT는 승인 없이 진행 가능, ASK/DEFER는 멈춤 |
...
| Rank | Task | 결정 | 상태 | 중요도 | 시간 | 가치/이유 | 다음 행동 |
|------|------|------|------|--------|------|-----------|-----------|
| 1 | [TASK-087](TASK-087-web-deploy-membership-gating.md) web deploy membership gating | REVIEW | 대기 | High / score 24 | XL · 24 ph | 높은 가치; gate: Owner direct request; NO live order, NO secret commit, NO production DB ... | R2 범위 진행, R3 전 확인 |

### ASK — Owner/외부 게이트

| Rank | Task | 결정 | 상태 | 중요도 | 시간 | 가치/이유 | 다음 행동 |
|------|------|------|------|--------|------|-----------|-----------|
| 1 | [TASK-094](TASK-094-admin-document-packet-hwpx-prototype.md) admin document packet hwpx prototype | ASK | 보류 | Medium / score -1 | L · 8 ph | 중간 가치; gate: start after TASK-093 and target official form selection; no Owner identi... | Owner/외부 조건 대기 |
...
| [TASK-094](TASK-094-admin-document-packet-hwpx-prototype.md) | Medium | Regulatory Admin | 8 ph / ~90000 tok | start after TASK-093 and target official form selection; no Owner identity data, no login, no submission, no legal/tax final advice |
