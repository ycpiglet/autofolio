...
> 생성 시각: `2026-06-14T17:34:11+09:00` · 열린 작업 20건
...
| 지표 | 값 | 해석 |
|------|----|------|
| 열린 작업 | 20건 / 163 ph | frontmatter 기준 |
| 진행 중 WIP | 0건 | WIP 적정 |
...
| 4 | [TASK-068](TASK-068-agent-runtime-eval-pilot.md) agent runtime eval pilot | ACT | 대기 | Medium / score 29 | M · 3 ph | 중간 가치 | 바로 착수 후보 |
