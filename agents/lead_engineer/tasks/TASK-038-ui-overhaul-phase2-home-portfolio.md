...
gate: blocked by TASK-037; no live orders
trigger_meeting: TASK-037 완료 후 자동 개시
...
# TASK-038 UI 대개편 Phase 2 — 홈 + 포트폴리오 (읽기 화면)
...
UI 대개편 Phase 2. TASK-037(Phase 1)에서 빈 AppShell이 완성된 상태에서 홈과 포트폴리오 읽기 화면을 구현한다. 데모 스코프 서버 강제 — 폴백 없이 에러는 에러로 표시.
...
- 마스터 플랜: `.claude/plans/glimmering-waddling-spring.md` §Phase 2
