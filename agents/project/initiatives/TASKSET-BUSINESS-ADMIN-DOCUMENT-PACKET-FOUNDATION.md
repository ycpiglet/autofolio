...
Create the reusable document-packet contract that a future business-registration
task can use later, while keeping actual official-form generation and submission
blocked.
