...
prod_boundary: "catalog and doc only; no product code, order path, risk policy, schema migration, secret, or prod mutation"
---
...
| 국내 ELW proxy | 카탈로그만 | MOCK-ONLY | — | 승인(proxy) | `MOCK-ONLY` | TASK-026 |
| 해외주식 (US/HK 등) | NOT-IMPL | NOT-IMPL | FX valuation 조건부 | 조건부 승인 (read-only/manual) | `CONDITIONAL` | TASK-022 |
| 글로벌 ETF | NOT-IMPL | NOT-IMPL | FX valuation 조건부 | 조건부 승인 (read-only/manual) | `CONDITIONAL` | TASK-022 |
...
| FX Futures/Options | NOT-IMPL | NOT-IMPL | 불가 | 보류/R3 | `R3-HOLD` | — |
...
| 상품 옵션 (Commodity Options) | NOT-IMPL | NOT-IMPL | education/scenario만 | 보류/R3 | `R3-HOLD` | TASK-027/028 |
...
| 장전 단일가 (07:30–08:30) | NOT-IMPL | `TTTT1006U`/`TTTT1005U` | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-014 |
| 장후 단일가 (15:40–16:00) | NOT-IMPL | `TTTT1006U`/`TTTT1005U` | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-014 |
| 시간외 종가 (16:00–18:00) | NOT-IMPL | 별도 TR | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-014 |
| 야간 선물/야간장 | NOT-IMPL | — | NOT-IMPL | NOT-IMPL | `R3-HOLD` | — |
| 해외장 (US/HK 마켓시간) | NOT-IMPL | 해외주식 별도 | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-022 |
| KRX 휴장일 차단 | SUPPORTED | `is_krx_holiday()` | SUPPORTED | SUPPORTED | `SUPPORTED` | — |

**SafetyChecker 근거**: `app/risk/trading_window.py` — `is_within_trading_window()` 09:10–15:20 KST 강제.
시간외 주문 TR은 `OrderFlow` 외부에서 별도 승인 없이 호출할 수 없다 (TASK-014 보류).
...
| 최유리지정가 | `03` | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-028 |
| 최우선지정가 | `04` | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-028 |
| 조건부지정가 | `05` | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-028 |
| Stop / Stop-Limit | NOT-IMPL | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-028 |
| Trailing Stop | NOT-IMPL | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-028 |
| IOC / FOK | NOT-IMPL | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-028 |
| MOO / MOC | NOT-IMPL | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-028 |
| OCO / OTO / OTOCO | NOT-IMPL | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-028 |
| 장전 단일가 주문 | NOT-IMPL | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-014 |
| 장후 단일가 주문 | NOT-IMPL | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-014 |

**근거**: `app/common/enums.py` — `OrderType` 열거형은 `LIMIT`, `MARKET` 두 값만 정의.
KIS `_ORD_DVSN_LIMIT = "00"`, `_ORD_DVSN_MARKET = "01"` 만 `kis_client.py`에서 사용.
...
| Block/Basket 다중 주문 | NOT-IMPL | NOT-IMPL | `R3-HOLD` | TASK-030 |
...
| 알림 탭 (UI) | `app/ui/views/alerts.py` | `SUPPORTED` | — |
...
| 포트폴리오 성과 attribution | `app/ui/views/portfolio.py` 기초 | `NOT-IMPL` (deep) | TASK-040 |
