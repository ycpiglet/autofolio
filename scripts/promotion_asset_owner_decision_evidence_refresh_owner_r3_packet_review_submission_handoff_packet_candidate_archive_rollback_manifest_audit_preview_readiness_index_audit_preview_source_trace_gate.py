"""Validate the TASK-160 readiness-index audit-preview source trace.
...
and drift from the TASK-159 source audit preview.
"""
...
SOURCE_AUDIT_PREVIEW_REL = (
    ...
    "PACKET-CANDIDATE-ARCHIVE-ROLLBACK-MANIFEST-AUDIT-PREVIEW-READINESS-INDEX-AUDIT-PREVIEW.json"
)
SOURCE_AUDIT_PREVIEW_ID = (
    "promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_submission_handoff_packet_candidate_"
    "archive_rollback_manifest_audit_preview_readiness_index_audit_preview"
)
SOURCE_AUDIT_PREVIEW_STATUS = (
    "local_owner_r3_packet_review_submission_handoff_packet_candidate_archive_rollback_manifest_audit_preview_"
    "readiness_index_audit_preview_not_actual_submission"
)
EXPECTED_SCHEMA = (
    "autofolio.promotion-asset-owner-decision-evidence-refresh-owner-r3-packet-review-submission-handoff-packet-"
    "candidate-archive-rollback-manifest-audit-preview-readiness-index-audit-preview-source-trace/v1"
)
EXPECTED_STATUS = (
    "local_owner_r3_packet_review_submission_handoff_packet_candidate_archive_rollback_manifest_audit_preview_"
...
TRACE_CHAIN = [
    {
        ...
        "next_path": (
            ...
            "HANDOFF-PACKET-CANDIDATE-ARCHIVE-ROLLBACK-MANIFEST-AUDIT-PREVIEW-READINESS-INDEX.json"
        ),
    ...
    },
    {
        ...
        "next_path": (
            "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-SUBMISSION-"
            "HANDOFF-PACKET-CANDIDATE-ARCHIVE-ROLLBACK-MANIFEST-AUDIT-PREVIEW.json"
        ),
        "relationship": "indexes_source_audit_preview_readiness",
    },
    {
        "trace_record_id": "source-trace-archive-rollback-manifest-audit-preview",
        "artifact_type": "archive_rollback_manifest_audit_preview",
        "source_id": (
            "promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_submission_handoff_packet_candidate_"
        ...
        "next_path": (
            "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-SUBMISSION-"
            "HANDOFF-PACKET-CANDIDATE-ARCHIVE-ROLLBACK-MANIFEST.json"
        ),
        "relationship": "audits_source_archive_rollback_manifest",
    },
    {
        "trace_record_id": "source-trace-archive-rollback-manifest",
        "artifact_type": "archive_rollback_manifest",
        "source_id": (
            "promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_submission_handoff_packet_candidate_"
            "archive_rollback_manifest"
        ),
        "path": (
            "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-SUBMISSION-"
            "HANDOFF-PACKET-CANDIDATE-ARCHIVE-ROLLBACK-MANIFEST.json"
        ),
        "status": "local_owner_r3_packet_review_submission_handoff_packet_candidate_archive_rollback_manifest_not_actual_submission",
        "next_path": (
            "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-SUBMISSION-"
            "HANDOFF-PACKET-CANDIDATE-AUDIT-PREVIEW.json"
        ),
        "relationship": "audited_source_handoff_packet_candidate_audit_preview_for_archive_rollback_manifest",
    },
    {
        "trace_record_id": "source-trace-handoff-packet-candidate-audit-preview",
        "artifact_type": "handoff_packet_candidate_audit_preview",
        ...
        "status": "local_owner_r3_packet_review_submission_handoff_packet_candidate_audit_readiness_preview_not_actual_submission",
        "next_path": (
            "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-SUBMISSION-"
            "HANDOFF-PACKET-CANDIDATE.json"
        ),
        "relationship": "audited_source_handoff_packet_candidate",
    },
    {
        "trace_record_id": "source-trace-handoff-packet-candidate",
        "artifact_type": "handoff_packet_candidate",
        "source_id": "promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_submission_handoff_packet_candidate",
        "path": (
            "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-SUBMISSION-"
            "HANDOFF-PACKET-CANDIDATE.json"
        ),
        "status": "local_owner_r3_packet_review_submission_handoff_packet_candidate_not_actual_submission",
        "next_path": (
            "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-SUBMISSION-"
            "PREFLIGHT-AUDIT-PREVIEW.json"
        ),
        "relationship": "source_submission_preflight_audit_preview_for_handoff_packet_candidate",
    },
    {
        "trace_record_id": "source-trace-submission-preflight-audit-preview",
        "artifact_type": "submission_preflight_audit_preview",
        "source_id": "promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_submission_preflight_audit_preview",
        "path": (
            "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-SUBMISSION-"
            "PREFLIGHT-AUDIT-PREVIEW.json"
        ),
        "status": "local_owner_r3_packet_review_submission_preflight_audit_readiness_preview_not_actual_submission",
        "next_path": "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-SUBMISSION-PREFLIGHT.json",
        "relationship": "audited_source_submission_preflight_contract",
    },
    {
        "trace_record_id": "source-trace-submission-preflight-contract",
        "artifact_type": "submission_preflight_contract",
        "source_id": "promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_submission_preflight_contract",
        "path": "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-SUBMISSION-PREFLIGHT.json",
        "status": "local_owner_r3_packet_review_submission_preflight_contract_not_actual_submission",
        "next_path": (
            "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-QUEUE-AUDIT-PREVIEW.json"
        ),
        "relationship": "source_review_queue_audit_preview",
    },
    {
        "trace_record_id": "source-trace-review-queue-audit-preview",
        "artifact_type": "review_queue_audit_preview",
        "source_id": "promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_queue_audit_preview",
        "path": (
            "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-QUEUE-AUDIT-PREVIEW.json"
        ),
        "status": "local_owner_r3_packet_review_queue_audit_readiness_preview_not_actual_approval",
        "next_path": "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-QUEUE.json",
        "relationship": "audited_source_contract",
    },
    {
        "trace_record_id": "source-trace-review-queue-contract",
        "artifact_type": "review_queue_contract",
        "source_id": "promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_queue_contract",
        "path": "agents/project/PROMOTION-ASSET-OWNER-DECISION-EVIDENCE-REFRESH-OWNER-R3-PACKET-REVIEW-QUEUE.json",
        "status": "local_owner_r3_packet_review_queue_contract_not_actual_approval",
        "next_path": None,
        "relationship": None,
    },
]
...
def _load_source_gate() -> Any:
    path = (
        REPO_ROOT
        / "scripts"
        / "promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_submission_handoff_packet_candidate_archive_rollback_manifest_audit_preview_readiness_index_audit_preview_gate.py"
    )
    spec = importlib.util.spec_from_file_location("readiness_index_audit_preview_gate", path)
...
REQUIRED_BOUNDARIES = {
    "local_owner_r3_packet_review_submission_handoff_packet_candidate_archive_rollback_manifest_audit_preview_readiness_index_audit_preview_source_trace_only",
...
REQUIRED_SUMMARY_COUNTS = {
    "chain_records": 10,
    "chain_records_with_hash_recorded": 10,
    "chain_records_with_existing_files": 10,
    "chain_records_with_non_action_status": 10,
    "upstream_source_links_verified": 9,
...
REQUIRED_TRACE_STEPS = {
    ...
    "trace_archive_rollback_manifest_chain",
    "trace_handoff_packet_candidate_chain",
    "trace_submission_preflight_and_review_queue_chain",
...
REQUIRED_TRACE_EVENTS = {
    ...
    "archive_rollback_manifest_chain_traced",
    "handoff_packet_candidate_chain_traced",
    "submission_preflight_review_queue_chain_traced",
...
def load_trace(path: Path = DEFAULT_TRACE) -> dict[str, Any]:
    ...
    if not isinstance(data, dict):
        raise ValueError("promotion asset readiness-index audit-preview source trace root must be an object")
    return data


def validate_trace(trace: dict[str, Any], repo_root: Path = REPO_ROOT) -> list[str]:
    source = _load_json(SOURCE_AUDIT_PREVIEW_PATH)
    findings: list[str] = []
    ...
    if trace.get("$schema") != EXPECTED_SCHEMA:
        findings.append("unexpected or missing promotion asset readiness-index audit-preview source trace schema")
    if trace.get("id") != f"{SOURCE_AUDIT_PREVIEW_ID}_source_trace":
        findings.append(f"id must be {SOURCE_AUDIT_PREVIEW_ID}_source_trace")
...
def _validate_sources(trace: dict[str, Any], repo_root: Path, source: dict[str, Any]) -> list[str]:
    ...
    for index_num, item in enumerate(inputs):
        ...
        if item.get("relationship") != "traces_source_readiness_index_audit_preview":
            findings.append(f"source_inputs[{index_num}].relationship must be traces_source_readiness_index_audit_preview")
    return findings
...
def _validate_handoff(trace: dict[str, Any]) -> list[str]:
    ...
    findings: list[str] = []
    if handoff.get("task_160_source_trace_ready") is not True:
        findings.append("taskset_handoff.task_160_source_trace_ready must be true")
    ...
    if handoff.get("next_task_candidate") != "TASK-161":
        findings.append("taskset_handoff.next_task_candidate must be TASK-161")
    for key in (
        "actual_owner_r3_review_submission_allowed",
        "actual_owner_review_start_allowed",
        "actual_refresh_execution_allowed",
...
def _validate_verification(trace: dict[str, Any]) -> list[str]:
    ...
    expected = {
        "local_gate": "python scripts/promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_submission_handoff_packet_candidate_archive_rollback_manifest_audit_preview_readiness_index_audit_preview_source_trace_gate.py --check",
        "focused_tests": "python -m pytest tests/unit/test_promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_submission_handoff_packet_candidate_archive_rollback_manifest_audit_preview_readiness_index_audit_preview_source_trace_gate.py -q",
        "source_gate": "python scripts/promotion_asset_owner_decision_evidence_refresh_owner_r3_packet_review_submission_handoff_packet_candidate_archive_rollback_manifest_audit_preview_readiness_index_audit_preview_gate.py --check",
    }
...
def main() -> int:
    ...
    if findings:
        print("promotion asset Owner/R3 readiness-index audit-preview source trace gate: FAIL")
        for finding in findings:
            print(f"- {finding}")
        return 1
    print(f"promotion asset Owner/R3 readiness-index audit-preview source trace gate: PASS ({args.trace})")
    return 0
