#!/usr/bin/env python3
"""Thin host wrapper for the staged agent_runtime inventory module."""
...
PACKAGE_SRC = ROOT / "packages" / "agent_runtime" / "src"
if str(PACKAGE_SRC) not in sys.path:
    sys.path.insert(0, str(PACKAGE_SRC))

from agent_runtime.inventory import (  # noqa: E402
    InventoryItem,
    analyze as _analyze,
    classify_path,
    render,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Classify files for Agent Runtime automation migration")
