...
ENTRYPOINT_NOTES = {
    ...
    "agent_runtime_migration_inventory.py": "Classifies reusable automation-core vs host/product paths before GitHub extraction.",
    "ralph_migration_inventory.py": "One-release legacy wrapper for agent_runtime_migration_inventory.py.",
}
